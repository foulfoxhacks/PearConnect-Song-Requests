...
<template>
  <main class="session-page">
    ...
    <div class="session-layout">
      ...
      <aside class="session-explainer"><h2>One request.<br>A clear result.</h2><ol><li><strong>Send it once.</strong><p>“Received” means your request arrived. Desktop still needs to check it.</p></li><li><strong>Wait for confirmation.</strong><p>“Enqueue confirmed” means Desktop found your song’s new queue entry. It may still be waiting to play.</p></li><li><strong>Give everyone a turn.</strong><p>Viewers on the same network share website request limits. Changing a display name doesn’t reset them.</p></li></ol><p>Streamers: create a code in <strong>PearConnect Desktop → Session-code fallback</strong>. Codes don’t grant dashboard access.</p><a href="/docs/session-codes">How session codes work →</a></aside>
    </div>
